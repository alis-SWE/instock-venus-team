        ...
        <div className="warehouse">
            <div className="warehouse__col-1"> 
                ...
                <div className="warehouse__address-container">
                    ...
                    <img src={deleteIcon} alt="" className='warehouse__delete' onClick={() => {setOpenModal(true)}}/>
            </div>
            ...
            <div className="warehouse__actions-container">
                <img src={deleteIcon} alt="" className='warehouse__delete--tablet' onClick={() => {setOpenModal(true)}}/>
                {/* {openModal && <DeleteWarehouse closeModal={setOpenModal}/>} */}
